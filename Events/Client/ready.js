...
module.exports = {
    ...
    async execute(client) {
        ...
        setInterval(() => {
            ...
            let nm = [
                `Smoke ${(client.guilds.cache.get('1058712013402017853').memberCount / 1000).toFixed(1) + 'K'}` , // Activity-1
                'https://moonteam.dev/', // Activity-2
                'https://discord.gg/smokee', // Activity-3
            ]
